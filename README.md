...
<table width="100%" style="border-collapse: collapse; border: none; margin-bottom: 10px;">
  <tr style="border: none; background: transparent;">
    <td align="left" valign="middle" style="border: none; padding: 0;">
      <!-- Aesthetic GIF (Left Side - Bypassing GitHub Camo Proxy) -->
      <img src="https://i.giphy.com/ooNYpzXriX2J7y5Di0.gif" alt="Vibe" height="65" style="border-radius: 6px; border: 1px solid #30363d; object-fit: cover;" />
    </td>
